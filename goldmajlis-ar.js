...
window.GM_TRANSLATIONS = {
  ...
  'home.sub.pre':       {en:'Live rates per gram in ',ar:'الأسعار المباشرة للغرام بـ '},
  'home.sub.post':      {en:' — updated every 10 min from global markets.',ar:' — يتحدث كل 10 دقائق من الأسواق العالمية.'},
  'home.th.gram':       {en:'Gram / ',             ar:'غرام / '},
  'home.th.kg':         {en:'KG / ',               ar:'كغ / '},
  ...
  'spark.sub':          {en:'Gold price per gram — up to 7 days',ar:'سعر الذهب للغرام — حتى 7 أيام'},
  ...
  'calc.score.over':    {en:'<45 · Overpriced',     ar:'أقل من 45 · مبالغ في سعره'},
  ...
  'bul.small':          {en:'Small Bars',           ar:'سبائك صغيرة'},
  'bul.small.range':    {en:'1g – 50g',             ar:'1غ – 50غ'},
  'bul.tola':           {en:'Tola Bars',            ar:'سبائك التولا'},
  'bul.tola.range':     {en:'Gulf & South Asian format',ar:'صيغة الخليج وجنوب آسيا'},
  'bul.large':          {en:'Medium & Large Bars',  ar:'سبائك متوسطة وكبيرة'},
  'bul.large.range':    {en:'100g – 1kg',           ar:'100غ – 1كغ'},
  'bul.coins':          {en:'Gold Coins',           ar:'عملات ذهبية'},
  'bul.coins.range':    {en:'Sovereign mints · 22K',ar:'سك حكومي · 22 قيراط'},
  'bul.dis':            {en:'<strong>Reference only.</strong> Calculated from live XAU/USD spot. Dealer prices include 3–8% premium. GoldMajlis does not sell gold.',ar:'<strong>استرشادي فقط.</strong> محسوب من سعر XAU/USD المباشر. أسعار الوكلاء تشمل علاوة 3–8٪. غولد مجلس لا يبيع الذهب.'},
  ...
  'learn.fmci.sub':     {en:'What you should pay per gram in Qatar',ar:'ما يجب أن تدفعه للغرام في قطر'},
  ...
  'footer.disclaimer':  {en:'Reference prices only — not financial advice. Not affiliated with any exchange, dealer, or financial institution.',ar:'أسعار استرشادية فقط — ليست نصيحة مالية. غير مرتبط بأي بورصة أو وكيل أو مؤسسة مالية.'},
  /* Stories */
  ...
  'learn.fmci.note3':   {en:'Bridal sets, custom, stone-set',ar:'طقم عرائس، مخصص، مرصع'},
  'learn.fmci.note4':   {en:'Negotiate or walk away', ar:'تفاوض أو انصرف'},
  'learn.fmci.cur.note':{en:'Updates when you change currency on the Home page',ar:'يتحدث عند تغيير العملة في الصفحة الرئيسية'},
  ...
  'about.body':         {en:'',ar:`
    ...
    <div class="about-section"><h3 class="about-h">تحديد المسؤولية</h3><p>لا تتحمل غولد مجلس ومشغلوها المسؤولية عن أي خسارة أو ضرر ناتج عن استخدامك للمنصة أو الاعتماد على أي معلومات أو أسعار أو أدوات أو محتوى مقدَّم عليها. النتائج والحسابات استرشادية فقط وليست نصيحة مالية.</p></div>
    <div class="about-section"><h3 class="about-h">الأهلية والعمر</h3><p>غولد مجلس مخصصة للمستخدمين الذين تبلغ أعمارهم 18 عاماً فأكثر، أو سن الرشد في ولايتهم القضائية، أيهما أكبر.</p></div>
    ...
    <div class="about-disclaimer"><div>© 2026 غولد مجلس · أسعار استرشادية فقط · ليست نصيحة مالية</div><div>غير مرتبط بأي بورصة أو وكيل أو مؤسسة مالية</div></div>`},
  'terms.body':         {en:'',ar:`
    ...
    <div class="about-section"><h3 class="about-h">طبيعة الخدمة</h3><p>غولد مجلس منصة مرجعية معلوماتية مستقلة. تُوفر بيانات أسعار الذهب وأدوات تسعير المجوهرات والمحتوى التعليمي لأغراض المعلومات العامة فقط. إنها ليست خدمة مالية أو منصة استثمارية أو منصة تداول أو بورصة أو أي منتج مالي منظَّم.</p></div>
    ...
    <div class="about-section"><h3 class="about-h">لا تُعدّ نصيحة مالية أو استثمارية</h3><p>جميع المحتويات في غولد مجلس — بما في ذلك المقالات والأدلة ونتائج الحاسبة وبيانات الأسعار — لأغراض المعلومات العامة فقط ولا تشكّل نصيحة مالية أو استثمارية أو ضريبية أو قانونية. تنطوي أسواق الذهب على مخاطر، وتحركات الأسعار السابقة لا تدل على الأداء المستقبلي.</p></div>
    <div class="about-section"><h3 class="about-h">تحديد المسؤولية</h3><p>لا تتحمل غولد مجلس ومشغلوها وشركاؤها المسؤولية عن أي خسارة أو ضرر ناتج عن استخدامك أو عدم قدرتك على استخدام هذه المنصة؛ أو الاعتماد على أي معلومات أو أسعار أو أدوات أو محتوى مقدَّم.</p></div>
    <div class="about-section"><h3 class="about-h">الملكية الفكرية</h3><p>جميع المحتويات والتصميمات والنصوص والبيانات في غولد مجلس ملك لمشغليها. يجوز لك استخدام المنصة للأغراض الشخصية غير التجارية فحسب. لا يجوز لك نسخ أو توزيع أو استغلال أي جزء من هذه المنصة تجارياً دون إذن مسبق.</p></div>
    <div class="about-section"><h3 class="about-h">الاستخدام المقبول</h3><p>توافق على عدم استخدام هذه المنصة في أي نشاط غير مشروع أو محاولة التدخل في تشغيلها أو جمع البيانات منها تجارياً بدون إذن.</p></div>
    <div class="about-section"><h3 class="about-h">الأهلية</h3><p>هذه المنصة مخصصة للمستخدمين الذين تبلغ أعمارهم 18 عاماً فأكثر.</p></div>
  ...
  'privacy.body':       {en:'',ar:`
    ...
    <div class="about-section"><h3 class="about-h">المعلومات التي نجمعها</h3><p>قد تستقبل خوادمنا معلومات تقنية محدودة مثل نوع المتصفح ومعلومات الجهاز والمنطقة الجغرافية العامة. نحن لا نجمع اسمك أو عنوان بريدك الإلكتروني أو أي معلومات تعريفية مباشرة ما لم تختر تقديمها.</p></div>
    ...
    <div class="about-section"><h3 class="about-h">التغييرات على هذه السياسة</h3><p>قد يتم تحديث سياسة الخصوصية هذه من وقت لآخر. يعكس تاريخ "آخر تحديث" في أعلى هذه الصفحة تاريخ آخر مراجعة.</p></div>
  ...
  /* Spark */
  'spark.eyebrow':      {en:'Price History',         ar:'تاريخ السعر'},
  'spark.sub':          {en:'Gold price per gram — up to 7 days of data',ar:'سعر الذهب للغرام — حتى 7 أيام من البيانات'},
...
window.GM_ARTICLES_AR={
  ...
  pricing:{tag:'التسعير',date:window._arDateStr||'محدّث 2026',title:'رسوم المصنعية — الرقم الذي يجب أن تطلبه دائماً',cta:'تحقق من عدالة رسوم المصنعية',
    body:`<p>كل سعر مجوهرات في قطر مكوّن من جزأين. معظم المشترين لا يفصلانهما.</p><h3>الرقمان</h3><p><strong>قيمة الذهب</strong> ثابتة — غير قابلة للتفاوض. <strong>رسوم المصنعية (أجرة)</strong> — قابلة للتفاوض تماماً.</p><p>اطلب دائماً هذين الرقمين منفصلَين.</p><h3>المعادلة</h3><p><strong>الإجمالي = (الوزن × سعر الذهب) + (الوزن × رسوم المصنعية)</strong></p><h3>صنع آلي مقابل يدوي</h3><p><strong>آلي</strong>: QAR 45–60/غ. <strong>يدوي/عرائس</strong>: QAR 65–75/غ.</p><blockquote>«الذهب واحد في كل متجر. الشيء الوحيد المختلف هو رسوم المصنعية.»</blockquote>`},
  ...
  souq:{tag:'سوق قطر',date:window._arDateStr||'محدّث 2026',title:'التسوق في أسواق ذهب الدوحة — دليل المطلعين',cta:'استخدم حاسبة المجوهرات',
    body:`<p>قطر تقدم ثلاث تجارب تسوق ذهب مختلفة.</p><h3>🏛️ سوق واقف</h3><p>أكثر تجارب التسوق أجواءً. الأسعار قابلة للتفاوض. الأفضل للتصفح والمقارنة.</p><h3>⚖️ سوق الريان للذهب</h3><p>منافسة أعلى وأسعار أفضل. حيث يتسوق السكان الجادون.</p><h3>🏪 متاجر المراكز التجارية</h3><p>داماس، مالابار، جوي أليوكاس. جودة متسقة مقابل راحة البال.</p><h3>ذهب العرائس</h3><p>الشبكة: قلادة وأقراط وسوار وخاتم — 21ق أو 22ق، 35–65 غراماً.</p><blockquote>«في قطر الذهب ذاكرة وتراث ولغة الاحتفال.»</blockquote>`},
...
window.GM_STRINGS = {
  ...
  spark_sub: 'سعر الذهب للغرام — حتى 7 أيام من البيانات',
  ...
  /* Table headers */
  th_gram: 'غرام / ', th_kg: 'كغ / ', th_oz: 'أوقية / ', th_pound: 'رطل / ', th_tola: 'تولا / ', th_karat: 'القيراط',

  /* General units */
  per_gram: 'للغرام', per_gram_short: '/غ', gram: 'غرام',
  ...
  calc_error: 'سعر الذهب غير متاح بعد. يرجى الانتظار لحظة والمحاولة مجدداً.',
  ...
  rate_high_warn: 'يبدو هذا السعر مرتفعاً بشكل غير معتاد — تحقق مرة أخرى.',
  rate_ok: 'يبدو السعر معقولاً.',
  currency_changed: 'تغيّرت العملة — أعد إدخال السعر بـ ',
  ...
  v_fair: 'سعر عادل',
  v_high: 'مرتفع قليلاً',
  v_over: 'مبالغ في سعره',
  v_way_over: 'مبالغ جداً في سعره',
  ...
  bsc: {
    '1g':'سبيكة 1غ', '2g':'سبيكة 2.5غ', '5g':'سبيكة 5غ', '10g':'سبيكة 10غ',
    tola:'1 تولا', oz:'سبيكة 1 أوقية', '100g':'سبيكة 100غ',
  ...
  footer_legal: '© 2026 غولد مجلس. أسعار استرشادية فقط — ليست نصيحة مالية. غير مرتبط بأي بورصة أو وكيل أو مؤسسة مالية.',
